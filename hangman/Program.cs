...
class Hangman {
    ...
    static void newGame() {
        ...
        while (true)
        {
            ...
            Console.WriteLine("Guesses left: " + g.guessesLeft);
            String board = g.printGuesses();
            Console.WriteLine(board);
            Console.WriteLine("Guess the whole word or guess a character in the word");
            String input = Console.ReadLine();
            //Console.WriteLine("DEBUG Input length: "+input.Length);
            //Console.WriteLine("DEBUG g.word " + g.word);
           /* Console.WriteLine("DEBUG g.searchableWrongWords contains: ");
            foreach (String s in g.searchableWrongWords) {
                Console.Write(s + " ");
            }
            Console.WriteLine("");*/
            ...
            {   
                ...
                //Console.WriteLine("DEBUG Guessed char Input is: "+guess[0]);
                g.GuessChar(guess[0]);
            }
            else {
                g.GuessWord(input);
